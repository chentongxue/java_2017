...
public class HTTP3SLG2 {
	 ...
	 * @param args
	 */
	public static String url = "http://ec2-52-33-4-138.us-west-2.compute.amazonaws.com/login?openid=&deviceCode=864895022518292-0c1dafc69140&channel=1042&deviceType=ANDROID&uniqueCode=14490646345&token=123";
...
//		String params = "openid=2342&deviceCode=8625&channel=1042&deviceType=ANDROID&uniqueCode=148&token=123";
		String params ="";
		String s = sendMsg(url,METHOD_GET, params, 1000);
