...
public class Pay {	
	public String generate(String userIdentity, String appId, String generalOrder, String t, 
			String appOrder, String amount, String payStatus, String serverId, String ext, String sign){
		...
		String signature = SecurityUtil.md5(original);
