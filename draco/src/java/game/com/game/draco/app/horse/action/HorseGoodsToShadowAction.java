...
public class HorseGoodsToShadowAction extends BaseAction<C2614_HorseGoodsToShadowReqMessage>{

	@Override
	public Message execute(ActionContext context,
			C2614_HorseGoodsToShadowReqMessage reqMsg) {
		...
		if(GoodsType.GoodsHorse != goodsType){
			return new C0002_ErrorRespMessage(reqMsg.getCommandId(),
