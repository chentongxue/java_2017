 ...
 * 历史鲜花榜
 */
public class RankRoleFlowerAllLogic extends RankRoleLogic{

	private static RankRoleFlowerAllLogic instance = new RankRoleFlowerAllLogic();
	private RankRoleFlowerAllLogic(){
	}
	
	public static RankRoleFlowerAllLogic getInstance(){
		return instance ;
	}
	...
	public RankType getRankType() {
		return RankType.Role_Flower_All ;
	}
...
//				.getName());
	...
	public void initLogData(RankInfo rankInfo){
		List<RankLogCountDB> rankLogCountDBList = GameContext.getRankDAO().selectFlower("sex", rankInfo.getSubType(), 
