...
public class SSDB{
	...
	public Response hgetAll(String name) throws Exception {
		return link.request("hgetall", name.getBytes(UTF8));
	}
	...
	private Response _zkeys(String cmd, String name, String key, String score_start, String score_end, int limit) throws Exception{
		if(key == null){
			key = "";
		}
		if(score_start == null){
	...
	public Response zrandom(String name, String key, String score_start, String score_end, int limit) throws Exception{
		return this._zscan("zrandom", name, key, score_start, score_end, limit);
	}
	
	public Response zkeys(String name, String key, String score_start, String score_end, int limit) throws Exception{
		return this._zkeys("zkeys", name, key, score_start, score_end, limit);
	}
	
	
	public Response zrandomkeys(String name, String key, String score_start, String score_end, int limit) throws Exception{
		return this._zkeys("zrandomkeys", name, key, score_start, score_end, limit);
	}
	...
	public Response multi_hget(String name, List<String> keys) throws Exception{
		Response resp = link.requestString("multi_hget", name, keys);
		if(!resp.ok()){
			resp.exception();
		}
		resp.buildMap();
