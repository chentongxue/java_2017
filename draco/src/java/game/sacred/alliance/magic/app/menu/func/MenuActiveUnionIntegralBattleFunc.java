...
public class MenuActiveUnionIntegralBattleFunc extends MenuAbstractActiveFunc{

	public MenuActiveUnionIntegralBattleFunc() {
		super(MenuIdType.UnionIntegralBattle);
	}
	...
	public Message createFuncReqMessage(RoleInstance role) {
		try {
			...
			C2541_UnionIntegralFightListReqMessage notifyMsg = new C2541_UnionIntegralFightListReqMessage();
			notifyMsg.setRound((byte)-1);
			return notifyMsg ;
		} catch (Exception e) {
