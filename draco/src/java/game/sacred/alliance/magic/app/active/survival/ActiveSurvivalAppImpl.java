package sacred.alliance.magic.app.active.survival;
...
public class ActiveSurvivalAppImpl implements ActiveSupport,Service {
	...
	public Message getActiveDetail(
		...
		C0282_SurvivalInfoReqMessage reqMsg = new C0282_SurvivalInfoReqMessage();
