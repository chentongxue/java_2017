 ...
 */
public class RoleLevel extends RankRoleLogic {

	private static RoleLevel instance = new RoleLevel();
	private RoleLevel(){
	}
	
	public static RoleLevel getInstance(){
		return instance ;
	}
	...
	public void initLogData(RankInfo rankInfo){
		List<RoleInstance> roleList = GameContext.getRankDAO().selectLevelRole("career", 
				rankInfo.getSubType(), 
