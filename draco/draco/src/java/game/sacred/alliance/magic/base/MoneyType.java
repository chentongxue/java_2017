...
public enum MoneyType {
	game(AttributeType.silverMoney.getType(),true,
			AttributeType.silverMoney,(short)150),
			
	rmb(AttributeType.goldMoney.getType(),true,
			AttributeType.goldMoney,(short)224),
			
	bindRmb(AttributeType.bindingGoldMoney.getType(),false,
			AttributeType.bindingGoldMoney,(short)0),
	;
