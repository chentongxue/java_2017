...
public class RoleServiceImpl implements RoleService {
	...
	private String createRole(RoleInstance role) throws ServiceException {
		String roleId = null;
		try {
	...
	public boolean deleteRole(int roleId) {
		int d = GameContext.getBaseDAO().update(RoleInstance.class,
				String.valueOf(roleId), new Date());
		return false;
	}
