...
public interface RespTypeStatus {
	...
	public static final int HANDUP_TOP_LEVEL=0;//Lv đã là cao nhất
	public static final int HANDUP_NOT_CONDITION=1;//Điều kiện không đủ
	public static final int HANDUP_EXP_LACK=2;//EXP không đủ để tăng cấp
	public static final int HANDUP_SUCCESS=3;//Thành công
	public static final int HANDUP_FAIL=4;//Thất bại
