...
public class ParasConfig extends PropertiesConfig {
	...
	private List<Integer> rewardPowerHourist = new ArrayList<Integer>();//赠送体力值的整点集合
	private Set<String> logMessagePrintRoleIdSet = new HashSet<String>();//消息日志强制输出的角色ID集合
	
	public List<Integer> getRewardPowerHourList() {
		if(null == rewardPowerHourist){
			this.rewardPowerHourist = this.reloadRewardPowerHourList();
		}
		return rewardPowerHourist;
	}

	private List<Integer> reloadRewardPowerHourList(){
		List<Integer> list = new ArrayList<Integer>();
		try {
			String cmdIdStr = this.getRewardRolePowerHours();
			...
			logger.error(this.getName() + ".reloadRewardPowerHourSet error: ", e);
		}
		return list;
	}
	
	/**
	 * 赠送体力值的时间整点（多个之间用逗号分割）
	 * @return
	 */
	private String getRewardRolePowerHours(){
		return String.valueOf(this.getConfig("rewardRolePowerHours"));
	}
	 ...
	 * @return
	 */
	public int getRewarRolePowerValue(){
		return Integer.valueOf(this.getConfig("rewarRolePowerValue"));
	}
	...
	public int getWorldMapBindingCost(){
		return Integer.parseInt(getConfig("worldMapBindingCost"));
	}
	...
	/** 商城开启的角色等级 */
	public int getShopOpenRoleLevel(){
		return Integer.valueOf(this.getConfig("shopOpenRoleLevel"));
	}
	...
	public int getComposRankUpdateMin(){
		return Integer.valueOf(this.getConfig("composRankUpdateMin"));
	}
	...
	public boolean isCheckUserChannelId(){
		String value = this.getConfig("checkUserChannelId");
		if(Util.isEmpty(value)){
			return false ;
		}
		value = value.trim();
	 ...
	 * @return
	 */
	public String getCloseVipPanelChannels(){
		return this.getConfig("closeVipPanelChannels");
	}
	...
	public byte getRecastingMinStar(){
		return Byte.parseByte(this.getConfig("recastingAttrMinStar"));
	}
	
	public byte getRecastingMaxStar(){
		return Byte.parseByte(this.getConfig("recastingAttrMaxStar"));
	}
