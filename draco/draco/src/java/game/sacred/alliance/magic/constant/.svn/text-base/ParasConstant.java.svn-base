...
public interface ParasConstant {
	...
	public static final int BIND_MONEY = Integer.MAX_VALUE;
	...
	public static final byte HERO_EQUIP_MAX_NUM = 10 ; //英雄装备个数
	public static final byte GODDESS_EQUIP_MAX_NUM = 6 ; //英雄装备个数
