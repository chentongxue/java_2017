...
public @Data class RoleEffect{
	...
	public int get(AttributeType attriType){
		switch(attriType){
			...
			case phyAtk:return this.getPhyAtk(); 
			case iceAtk:return this.getIceAtk(); 
			case fireAtk :return this.getFireAtk(); 
			case sacredAtk:return this.getSacredAtk();
			case phyRit :return this.getPhyRit(); 
			case iceRit :return this.getIceRit(); 
			case fireRit :return this.getFireRit(); 
			...
			case agedRitRate :return this.getAgedRitRate(); 
			...
			case agedAddRate :return this.getAgedAddRate(); 
	...
	public boolean set(byte enumValue,int value){
		...
		switch(attriType){
			...
			case phyAtk: this.setPhyAtk(value); return true;
			case iceAtk: this.setIceAtk(value); return true;
			case fireAtk : this.setFireAtk(value); return true;
			case sacredAtk : this.setSacredAtk(value);return true ;
			case phyRit : this.setPhyRit(value); return true;
			case iceRit : this.setIceRit(value); return true;
			case fireRit : this.setFireRit(value); return true;
			...
			case agedRitRate : this.setAgedRitRate(value); return true;
			...
			case agedAddRate : this.setAgedAddRate(value); return true;
