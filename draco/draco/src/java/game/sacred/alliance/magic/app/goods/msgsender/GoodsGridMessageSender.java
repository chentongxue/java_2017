...
public class GoodsGridMessageSender {
	...
	private List<GoodsSynchDataItem> buildList(RoleInstance role, 
		...
		}else if(StorageType.equip.getType() == storageType){
			maxGridCount = ParasConstant.ROLE_EQUIP_MAX_NUM;
		...
		}else if(StorageType.goddess.getType() == storageType){
			maxGridCount = ParasConstant.GODDESS_EQUIP_MAX_NUM ;
		}
		GoodsSynchDataItem goodsSynchDataItem  = GoodsHelper.buildSynchDataItem(role, goodsList, 
