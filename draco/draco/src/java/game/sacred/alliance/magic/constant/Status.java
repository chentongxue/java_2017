...
public enum Status {
	...
	Sys_PhoneNo_Not_Null(0,(byte)11,false,TextId.Sys_PhoneNo_Not_Null),
	Sys_PhoneNo_Not_Null_affirm(0,(byte)12,false,TextId.Sys_PhoneNo_Not_Null_affirm),
	Sys_PhoneNo_Different(0,(byte)13,false,TextId.Sys_PhoneNo_Different),
	Sys_PhoneNo_Num_Error(0,(byte)14,false,TextId.Sys_PhoneNo_Num_Error),
	Sys_PhoneNo_Input_Error(0,(byte)15,false,TextId.Sys_PhoneNo_Input_Error),
	Sys_Charge_Not_Open(0,(byte)16,false,TextId.Sys_Charge_Not_Open),
	Sys_Gm_Id_Be_Login(0,(byte)17,false,TextId.Sys_Gm_Id_Be_Login),
	...
	Role_Delete_Success(3,(byte)25,false,TextId.Role_Delete_Success),
	Role_Delete_Fail(3,(byte)26,false,TextId.Role_Delete_Fail),
	...
	Role_No_Can_Reward(3,(byte)31,false,TextId.Role_No_Can_Reward),
	...
	//副本组队
	Team_Copy_Param_Copy_Null(9,(byte)1,false,TextId.Team_Copy_Param_Copy_Null),
	Team_Copy_Not_Allow(9,(byte)2,false,TextId.Team_Copy_Not_Allow),
	Team_Copy_Member_Full(9,(byte)3,false,TextId.Team_Copy_Member_Full),
	Team_Copy_IsIn(9,(byte)4,false,TextId.Team_Copy_IsIn),
	Team_Copy_In_Match(9,(byte)5,false,TextId.Team_Copy_In_Match),
	Team_Copy_Role_Not_Online(9,(byte)6,false,TextId.Team_Copy_Role_Not_Online),
	Team_Copy_Role_In_Arena(9,(byte)7,false,TextId.Team_Copy_Role_In_Arena),
	Team_Copy_Map_Not_Exist(9,(byte)8,false,TextId.Team_Copy_Map_Not_Exist),
	Team_Copy_Not_Match(9,(byte)9,false,TextId.Team_Copy_Not_Match),
	Team_Copy_Enter_Copy_Match(9,(byte)10,false,TextId.Team_Copy_Enter_Copy_Match),
	Team_Copy_Role_Not_Apply(9,(byte)11,false,TextId.Team_Copy_Role_Not_Apply),
	Team_Copy_Team_Can_Apply(9,(byte)12,false,TextId.Team_Copy_Team_Can_Apply),
	Team_Copy_Team_Leave_Match(9,(byte)13,false,TextId.Team_Copy_Team_Leave_Match),
	Team_Copy_MATCH_FAIL_BY_TEAM_MEMBER_CHANGE(9,(byte)14,false,TextId.Team_Copy_MATCH_FAIL_BY_TEAM_MEMBER_CHANGE),
	...
	Goods_Fashion_Permanent(15,(byte)1,false,TextId.Goods_Fashion_Permanent),
	...
	GOODS_NO_PAY(15,(byte)11,false,TextId.GOODS_NO_PAY),
	GOODS_OUT_YEAR(15,(byte)12,false,TextId.GOODS_OUT_YEAR),
	GOODS_PAY_TIME_ERR(15,(byte)13,false,TextId.GOODS_PAY_TIME_ERR),
	GOODS_PAY_TYPE_ERR(15,(byte)14,false,TextId.GOODS_PAY_TYPE_ERR),
	GOODS_PAY_MONEY_LASS(15,(byte)15,false,TextId.GOODS_PAY_MONEY_LASS),
	GOODS_COMPOSE_EXPIRED(15,(byte)16,false,TextId.GOODS_COMPOSE_EXPIRED),
	GOODS_NO_COMPOSE(15,(byte)17,false,TextId.GOODS_NO_COMPOSE),
	GOODS_GROUPID_COMPOSE_ERR(15,(byte)18,false,TextId.GOODS_GROUPID_COMPOSE_ERR),
	GOODS_COMPOSE_IS_TOW(15,(byte)19,false,TextId.GOODS_COMPOSE_IS_TOW),
	GOODS_COMPOSE_MONEY_LESS(15,(byte)20,false,TextId.GOODS_COMPOSE_MONEY_LESS),
	GOODS_COMPOSE_IS_FOREVER(15,(byte)21,false,TextId.GOODS_COMPOSE_IS_FOREVER),
	GOODS_IS_EXPIRED(15,(byte)22,false,TextId.GOODS_IS_EXPIRED),
	GOODS_COMPOSE_EXPIRED_DEL(15,(byte)23,false,TextId.GOODS_COMPOSE_EXPIRED_DEL),
	GOODS_GENDER_ERR(15, (byte)24, false, TextId.GOODS_GENDER_ERR),
	...
	Goods_Transfer_Success(15,(byte)32,false,TextId.Goods_Transfer_Success),
	...
	Exchange_Money_Not_Enough(18, (byte)8, false, TextId.Exchange_Money_Not_Enough),
	Exchange_Faction_Not_Has(18, (byte)9, false, TextId.Exchange_Faction_Not_Has),
	Exchange_Faction_INTEGAL_NotEnough(18, (byte)10, false, TextId.Exchange_Faction_INTEGAL_NotEnough),
	Exchange_UNION_DKP_NotEnough(18, (byte)11, false, TextId.Exchange_UNION_DKP_NotEnough),
	Exchange_Honor_NotEnough(18, (byte)12, false, TextId.Exchange_Honor_NotEnough),
	Exchange_Bind_Money_Not_Enough(18, (byte)13, false, TextId.Exchange_Bind_Money_Not_Enough),
	Exchange_Gold_Money_Not_Enough(18, (byte)14, false, TextId.Exchange_Gold_Money_Not_Enough),
	...
	//福利-离线经验
	Offline_Obj_Null(21, (byte)0, false, TextId.Offline_Obj_Null),
	Offline_Award_Null(21, (byte)1, false, TextId.Offline_Award_Null),
	Offline_Is_Null(21, (byte)2, false, TextId.Offline_Is_Null),
	Offline_No_Multiple(21, (byte)3, false, TextId.Offline_No_Multiple),
	Offline_Param_Error(21, (byte)4, false, TextId.Offline_Param_Error),
	Offline_No_Free(21, (byte)5, false, TextId.Offline_No_Free),
	Offline_Money_Error(21, (byte)6, false, TextId.Offline_Money_Error),
	Offline_Money_Less(21, (byte)7, false, TextId.Offline_Money_Less),
	Offline_Money_Type_Err(21, (byte)8, false, TextId.Offline_Money_Type_Err),

	//福利-每日登录
	Login_Not_Can_Reward(21, (byte)11, false, TextId.Login_Not_Can_Reward),
	Login_Req_Param_Error(21, (byte)12, false, TextId.Login_Req_Param_Error),
	...
	//副本
	Copy_Npc_Func_Today_Count(24,(byte)4,false,TextId.Copy_Npc_Func_Today_Count),
	Copy_Not_Suit_Pre(24,(byte)5,false,TextId.Copy_Not_Suit_Pre),
	Copy_Bigger_Than_Pre(24,(byte)6,false,TextId.Copy_Bigger_Than_Pre),
	Copy_Condition_Role(24,(byte)7,false,TextId.Copy_Condition_Role),
	Copy_Curr_Role_Num(24,(byte)8,false,TextId.Copy_Curr_Role_Num),
	Copy_Enter_No_Goods(24,(byte)9,false,TextId.Copy_Enter_No_Goods),
	Copy_Enter_No_Quest(24,(byte)10,false,TextId.Copy_Enter_No_Quest),
	Copy_Enter_No_Mount(24,(byte)11,false,TextId.Copy_Enter_No_Mount),
	Copy_Enter_No_Title(24,(byte)12,false,TextId.Copy_Enter_No_Title),
	Copy_Enter_No_Lvl(24,(byte)13,false,TextId.Copy_Enter_No_Lvl),
	Copy_Enter_No_VipLvl(24,(byte)14,false,TextId.Copy_Enter_No_VipLvl),
	Copy_Enter_No_FactionLvl(24,(byte)15,false,TextId.Copy_Enter_No_FactionLvl),
	Copy_Enter_No_Faction(24,(byte)16,false,TextId.Copy_Enter_No_Faction),
	Copy_Today_Count_Finished(24,(byte)17,false,TextId.Copy_Today_Count_Finished),
	Copy_Leader_Not_Enter(24,(byte)18,false,TextId.Copy_Leader_Not_Enter),
	Copy_Team_Member_Not_Same_Faction(24,(byte)19,false,TextId.Copy_Team_Member_Not_Same_Faction),
	Copy_Team_Member_Today_Count_Finished(24,(byte)20,false,TextId.Copy_Team_Member_Today_Count_Finished),
	Copy_Role_Enter_Copy(24,(byte)21,false,TextId.Copy_Role_Enter_Copy),
	Copy_Leader_Create_Copy_Need_Enter(24,(byte)22,false,TextId.Copy_Leader_Create_Copy_Need_Enter),
	Copy_Not_Enter_In_Auto_Team(24,(byte)24,false,TextId.Copy_Not_Enter_In_Auto_Team),
	Copy_Role_Power_Not_Enough(24,(byte)25,false,TextId.Copy_Role_Power_Not_Enough),

	MAP_NOT_SUPPORT_EXIT(24,(byte)25,false,TextId.MAP_NOT_SUPPORT_EXIT),

	Copy_Reborn_Trans_Out(24,(byte)26,false,TextId.Copy_Reborn_Trans_Out),
	Copy_Not_Can_Trans(24,(byte)27,false,TextId.Copy_Not_Can_Trans),
	Copy_Trans_Out_Error(24,(byte)28,false,TextId.Copy_Trans_Out_Error),
	Copy_Role_Leave_Copy(24,(byte)29,false,TextId.Copy_Role_Leave_Copy),
