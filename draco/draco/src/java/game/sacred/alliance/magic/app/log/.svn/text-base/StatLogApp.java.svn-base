...
public interface StatLogApp extends Service{
	 ...
	 * @param role
	 */
	//public void  userActiveLog(RoleInstance role);
	/**
	 * 角色注册日志
	 * @param role
	 */
	 ...
	 * @param role
	 * @param strInfo
	 * @param targetBeforeLevel
	 * @param result
	 *//*
	public void equipStrengShiftLog(RoleInstance role, String strInfo,
			int targetBeforeLevel, EquipTransferResult result);*/
	/**
	 * 玩家杀怪日志
	 * @param role
	 * @param npc
	 ...
	 * @param isSuccess
	 */
	public void towerLog(RoleInstance role, MapConfig mc,
			String scoreLeve, int exp, int isSuccess);
	/**
	 * 角色钱变化的日志
	 * @param role
	 * @param attriType
...
//	public void roleGoodsLog(RoleInstance role, OutputConsumeType ocType, String remark,List<RoleGoods> upList,List<RoleGoods> addList);
	 ...
	 * 天命轮回宝箱
	 * @param role
	 * @param chestType 宝箱类型（0破旧木箱  1山贼财宝  2皇帝密库   3神秘宝藏    4巫族遗物）
	 */
...
//	public void offhookLog(RoleInstance role, int hookType);
	 ...
	 * @param logContent
	 */
	public void mailSendInfoPickLog(RoleInstance role,Mail mail,List<MailAccessory> maList,int exp,int gold,int bindGold,int silverMoney,int contribute,int zp,int magicSoul);
