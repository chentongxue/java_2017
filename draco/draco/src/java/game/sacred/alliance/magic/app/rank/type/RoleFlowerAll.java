 ...
 */
public class RoleFlowerAll extends RankRoleLogic{

	private static RoleFlowerAll instance = new RoleFlowerAll();
	private RoleFlowerAll(){
	}
	
	public static RoleFlowerAll getInstance(){
		return instance ;
	}
