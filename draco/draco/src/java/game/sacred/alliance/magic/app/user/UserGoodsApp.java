...
public interface UserGoodsApp {
	...
	public RoleGoods getRoleGoods(RoleInstance role, StorageType storageType, String goodsInstanceId);
...
//	public PutSomeGoodsResult addSomeGoodsForBag(RoleInstance role, Map<Integer, Integer> addMap, OutputConsumeType outputConsumeType);
	 ...
	 * 返回资源ID
	 * @param role
	 * @param fashionLocationType
	 * @param equipLocationType
	 * @return
	 */
	public int getResIdByGoods(RoleInstance role, EquipslotType fashionLocationType);
	/**
	 * 下线异常日志
	 * @param role
	 */
