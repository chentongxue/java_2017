...
public abstract class GoodsBase  {
	...
	//装备最大孔数
	protected byte openHoleNum;
	protected short suitId;//套装ID
	protected short suitGroupId;//套装组ID
	...
	public boolean isEquipment() {
		return goodsType == GoodsType.GoodsEquHuman.getType()
				|| goodsType == GoodsType.GoodsEquGoddess.getType()
				|| goodsType == GoodsType.GoodsFashion.getType();
	}
...
/******************************   getter/setter   *******************************************/
	...
	public byte getOpenHoleNum() {
		return openHoleNum;
	}

	public void setOpenHoleNum(byte openHoleNum) {
		this.openHoleNum = openHoleNum;
	}

	public short getSuitId() {
		return suitId;
	}

	public void setSuitId(short suitId) {
		this.suitId = suitId;
	}
	...
	protected void setGoodsLiteItem(GoodsLiteItem item){
