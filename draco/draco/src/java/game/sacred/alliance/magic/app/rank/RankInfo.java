...
public @Data class RankInfo implements KeySupport<Integer> {
	...
	private byte type; //排行榜9大类型
	private byte subType; //排行榜小类型,eg:等级包含（八荒,天师,青藤）
	private short tagResId; //排行榜页签文字
	private short disCount; //排行显示条目数
	...
	public boolean init(){
		...
		String[] times = Util.splitStr(rewardTime, COMMA);
