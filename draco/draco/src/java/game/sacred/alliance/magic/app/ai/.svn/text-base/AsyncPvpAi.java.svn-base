...
public class AsyncPvpAi extends DefaultAi {
    ...
    public void init() {
        ...
        //设置默认状态
        State defaultState = GameContext.getAiApplication().getNpcDefaultState(npcRole);
    ...
    public void enterEvadeMode(){
        ...
        State defaultState = GameContext.getAiApplication().getNpcDefaultState((NpcInstance)role);
        role.getAi().getStateMachine().switchState(defaultState);
