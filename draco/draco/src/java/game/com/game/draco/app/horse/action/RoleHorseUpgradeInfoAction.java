...
public class RoleHorseUpgradeInfoAction extends BaseAction<C2605_RoleHorseUpgradeInfoReqMessage> {
	...
	public Message execute(ActionContext context, C2605_RoleHorseUpgradeInfoReqMessage reqMsg) {
		...
		respMsg = GameContext.getRoleHorseApp().sendC2605_RoleHorseUpgradeInfoRespMessage(role,horseId);
