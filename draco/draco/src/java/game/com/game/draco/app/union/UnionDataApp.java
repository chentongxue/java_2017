...
public interface UnionDataApp extends Service{
	 ...
	 * @return
	 */
	Map<UnionDescType, UnionDes> getDescribeMap();
	 ...
	 * @return
	 */
	UnionDpsResult getUnionDpsResult(String bossId);
	 ...
	 * @return
	 */
	Set<String> getUnionDpsResult(byte groupId);
