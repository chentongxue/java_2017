...
public @Data class Union implements java.io.Serializable{
	...
	//角色捐献次数<角色Id,捐献数据>
	private Map<Integer,UnionMemberDonate> donateMap = Maps.newHashMap();
	...
	//公会公告
	private String unionDesc = "千秋万载，一统江湖!";
	 ...
	 * @param count
	 */
	public void saveMemberDonate(UnionMemberDonate donate){
		donateMap.put(donate.getRoleId(),donate);
	}
	
	public UnionMemberDonate getMemberDonate(int roleId){
		return donateMap.get(roleId);
	}
	 ...
	 * @return
	 */
	public UnionMember addMember(String unionId,RoleInstance role,byte type){
