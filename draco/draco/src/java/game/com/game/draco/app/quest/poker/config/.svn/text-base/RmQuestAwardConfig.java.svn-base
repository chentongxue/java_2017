...
public @Data class RmQuestAwardConfig {
	...
	public Result checkAndInit(){
		...
		this.questAward.addToAttributeMap(AttributeType.silverMoney, this.gameMoney);
		this.questAward.addToAttributeMap(AttributeType.bindingGoldMoney, this.bindGold);
