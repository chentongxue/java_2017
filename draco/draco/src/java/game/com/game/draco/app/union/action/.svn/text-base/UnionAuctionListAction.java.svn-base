 ...
 *
 */
public class UnionAuctionListAction extends BaseAction<C2759_UnionAuctionListRespMessage> {

	@Override
	public Message execute(ActionContext context, C2759_UnionAuctionListRespMessage reqMsg) {
