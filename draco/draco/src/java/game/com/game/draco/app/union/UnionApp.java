...
public interface UnionApp{
	 ...
	 * @return
	 */
	List<Union> getUnionListByName(String unionName);
...
//	C1727_UnionDonateInfoRespMessage getUnionDonateInfo(RoleInstance role);
	 ...
	 * @param type
	 */
	void changeMemberDkp(RoleInstance role, int value,OperatorType operatorType, FunType type);
